...
'
my @modrinthMods = ('axiom', 'carpet', 'modmenu','reeses-sodium-options', 'mouse-wheelie','no-chat-reports', 'mixintrace', 'mixin-conflict-helper', 'xaeros-minimap', 'xaeros-world-map', 'yosbr', 'multiconnect', 'sodium-extra', 'why-am-i-on-fire', "peek", "brb", 'litematica', 'minihud', 'tellme', 'tweakeroo','item-scroller',"distanthorizons");
#my @curseforgeMods = ();
#'notenoughcrashes', 
